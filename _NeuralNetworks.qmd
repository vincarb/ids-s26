...
![Neural network diagram](neural-network-diagrams/simple_diagram.png)
...
![Neuron diagram](neural-network-diagrams/neuron_diagram.png)
...
- **random_state=42** sets the random seed just saw the data splits the same time every run.  
...
players = ["Jaylen Brown","Jayson Tatum", "Al Horford", "Jrue Holiday", "Kristaps Porziņģis", "Sam Hauser", "Luke Kornet"]
